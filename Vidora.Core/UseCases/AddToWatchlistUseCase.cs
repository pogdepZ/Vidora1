...
public class AddToWatchlistUseCase
{
    ...
    public AddToWatchlistUseCase(IWatchlistApiService watchlistApiService)
    {
    ...
    public async Task<Result<ToggleWatchlistResult>> ExecuteAsync(int movieId)
    {
        ...
        {
            return Result.Failure<ToggleWatchlistResult>($"Lỗi thêm vào danh sách yêu thích: {ex.Message}");
        }
    }
}
